...
Após a análise e compreensão do problema de inserção e remoção de \emph{Stoplogs} em visita de campo, foi feita uma
\textbf{Pesquisa Bibliográfica} e \emph{brainstorm} com o objetivo de alcançar um conceito sólido de solução para o problema.
